...
#SBATCH --time=2:00:00
#SBATCH --job-name=cmp270-job2
#SBATCH --output=%x_%j.out
#SBATCH --error=%x_%j.err

# QUANDO RODAR ESSE SCRIPT, POR FAVOR, RETIRAR A FLAG -ftrace DO ARQUIVO ./config/NAS.samples/make.def_ncc

export PATH=/opt/nec/ve/nfort/3.0.4/bin:$PATH
export PATH=/opt/nec/ve/ncc/3.0.4/bin:$PATH
export VE_PROGINF=NO
